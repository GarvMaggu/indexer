...
exports.getCollectionFloorAskOracleV4Options = void 0;
...
const version = "v4";
exports.getCollectionFloorAskOracleV4Options = {
    ...
    validate: {
        query: joi_1.default.object({
            ...
            twapSeconds: joi_1.default.number().default(0),
            eip3668Calldata: joi_1.default.string(),
            collection: joi_1.default.string().lowercase(),
            token: joi_1.default.string().pattern(utils_1.regex.token).lowercase(),
        })
            .or("collection", "token")
    ...
    handler: async (request) => {
        ...
        if (query.token) {
            ...
            const collectionResult = await db_1.edb.oneOrNone(`
          SELECT
      ...
      `;
            ...
            let decimals = 18;
            if (query.kind === "spot") {
                const result = await db_1.redb.oneOrNone(spotQuery, query);
                ...
                const result = await db_1.redb.oneOrNone(twapQuery, query);
                if (!(result === null || result === void 0 ? void 0 : result.price)) {
                    throw Boom.badRequest("No floor ask price available");
                }
                kind = PriceKind.TWAP;
                ...
                const spotResult = await db_1.redb.oneOrNone(spotQuery, query);
                const twapResult = await db_1.redb.oneOrNone(twapQuery, query);
            ...
            if (query.token) {
                ...
                id = hash_1._TypedDataEncoder.hashStruct("CollectionPriceByToken", EIP712_TYPES.CollectionPriceByToken, {
                    kind,
