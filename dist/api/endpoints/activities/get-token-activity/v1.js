...
exports.getTokenActivityV1Options = void 0;
...
const version = "v1";
exports.getTokenActivityV1Options = {
    ...
    handler: async (request) => {
        ...
        try {
            ...
            const activities = await activities_1.Activities.getTokenActivities(contract, tokenId, query.continuation, query.types, query.limit);
