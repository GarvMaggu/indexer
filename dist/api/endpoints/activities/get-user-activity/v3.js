...
exports.getUserActivityV3Options = void 0;
...
const version = "v3";
exports.getUserActivityV3Options = {
    ...
    handler: async (request) => {
        ...
        try {
            const activities = await user_activities_1.UserActivities.getActivities(query.users, [], "", query.continuation, query.types, query.limit, query.sortBy);
