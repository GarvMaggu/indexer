...
exports.getCollectionActivityV4Options = void 0;
...
const version = "v4";
exports.getCollectionActivityV4Options = {
    ...
    handler: async (request) => {
        ...
        try {
            const activities = await activities_1.Activities.getCollectionActivities(query.collection, query.community, query.collectionsSetId, query.continuation, query.types, query.limit, query.sortBy, query.includeMetadata);
