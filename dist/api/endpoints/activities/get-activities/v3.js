...
exports.getActivityV3Options = void 0;
...
exports.getActivityV3Options = {
    ...
    handler: async (request) => {
        ...
        try {
            const activities = await activities_1.Activities.getActivities(query.continuation, query.limit, true);
            ...
            if (activities.length === query.limit) {
                ...
                if (lastActivity) {
                    continuation = (0, utils_1.buildContinuation)(`${lastActivity.eventTimestamp}_${lastActivity.id}`);
                }
            }
