...
exports.postRefreshCollectionFlagsOptions = void 0;
...
exports.postRefreshCollectionFlagsOptions = {
    ...
    validate: {
        ...
        payload: joi_1.default.object({
            collection: joi_1.default.string()
                ...
                .required(),
            backfill: joi_1.default.boolean().default(false),
        }),
    },
    handler: async (request) => {
        ...
        try {
            ...
            logger_1.logger.error(`post-refresh-collection-flags-handler`, `Handler failure: ${error}`);
            throw error;
        }
    },
};
//# sourceMappingURL=post-refresh-collection-flags.js.map