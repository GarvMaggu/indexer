...
exports.postFixBlocksOptions = {
    ...
    validate: {
        ...
        payload: joi_1.default.object({
            fromBlock: joi_1.default.number().required(),
            toBlock: joi_1.default.number().required(),
        }),
    },
    handler: async (request) => {
        ...
        try {
            ...
            logger_1.logger.error("post-fix-blocks-handler", `Handler failure: ${error}`);
            throw error;
        }
    },
};
//# sourceMappingURL=post-fix-blocks.js.map