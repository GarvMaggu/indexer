...
exports.postSyncArweaveOptions = {
    ...
    handler: async (request) => {
        ...
        try {
            ...
            logger_1.logger.error("post-sync-arweave-handler", `Handler failure: ${error}`);
            throw error;
        }
    },
};
//# sourceMappingURL=post-sync-arweave.js.map