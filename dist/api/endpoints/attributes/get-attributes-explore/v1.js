...
exports.getAttributesExploreV1Options = void 0;
...
const version = "v1";
exports.getAttributesExploreV1Options = {
    ...
    validate: {
        ...
        query: joi_1.default.object({
            attributeKey: joi_1.default.string().description("Filter to a particular attribute key, e.g. `Composition`"),
            ...
            limit: joi_1.default.number().integer().min(1).max(5000).default(20),
        }),
    },
    response: {
