...
exports.getAsksEventsV2Options = void 0;
...
const version = "v2";
exports.getAsksEventsV2Options = {
    cache: {
        privacy: "public",
        expiresIn: 5000,
    },
    ...
    response: {
        ...
        failAction: (_request, _h, error) => {
            logger_1.logger.error(`get-asks-events-${version}-handler`, `Wrong response schema: ${error}`);
            throw error;
        },
    },
    handler: async (request) => {
      ...
      `;
            ...
            const result = await Promise.all(rawResult.map(async (r) => {
                ...
                return ({
                    order: {
                        ...
                        nonce: (_b = r.order_nonce) !== null && _b !== void 0 ? _b : null,
                        validFrom: r.valid_from ? Number(r.valid_from) : null,
                        validUntil: r.valid_until ? Number(r.valid_until) : null,
                        source: (_c = sources.get(r.order_source_id_int)) === null || _c === void 0 ? void 0 : _c.name,
            ...
            logger_1.logger.error(`get-asks-events-${version}-handler`, `Handler failure: ${error}`);
            throw error;
        }
    },
};
