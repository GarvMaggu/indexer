...
exports.getStatsV2Options = void 0;
...
exports.getStatsV2Options = {
                ...
                market: joi_1.default.object({
                    floorAsk: joi_1.default.object({
                        ...
                        token: joi_1.default.object({
                            ...
                            tokenId: joi_1.default.string().lowercase().pattern(utils_1.regex.number).allow(null),
    ...
    handler: async (request) => {
        ...
        `;
            ...
            const result = await db_1.redb.oneOrNone(baseQuery, query).then(async (r) => {
                var _a, _b, _c, _d;
                return r
                    ? {
                        ...
                        market: {
                            floorAsk: {
                                ...
                                price: r.floor_sell_id
                                    ? await (0, joi_2.getJoiPriceObject)({
                                        net: {
                                            amount: (0, utils_1.getNetAmount)((_a = r.floor_sell_currency_value) !== null && _a !== void 0 ? _a : r.floor_sell_value, r.floor_sell_fee_bps),
                                            nativeAmount: (0, utils_1.getNetAmount)(r.floor_sell_value, r.floor_sell_fee_bps),
                                        },
                                        gross: {
                                            amount: (_b = r.floor_sell_currency_value) !== null && _b !== void 0 ? _b : r.floor_sell_value,
                            ...
                            topBid: {
                                ...
                                price: r.top_buy_id
                                    ? await (0, joi_2.getJoiPriceObject)({
                                        net: {
                                            amount: (_c = r.top_buy_currency_value) !== null && _c !== void 0 ? _c : r.top_buy_value,
                                            nativeAmount: r.top_buy_value,
                                        },
                                        gross: {
                                            amount: (_d = r.top_buy_currency_price) !== null && _d !== void 0 ? _d : r.top_buy_price,
