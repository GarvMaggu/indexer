...
exports.getExecuteBidV3Options = void 0;
...
const version = "v3";
exports.getExecuteBidV3Options = {
        ...
        try {
            ...
            for (let i = 0; i < payload.params.length; i++) {
                ...
                switch (params.orderKind) {
                    ...
                    case "zeroex-v4": {
                        ...
                        if (((_c = params.fee) === null || _c === void 0 ? void 0 : _c.length) !== ((_d = params.feeRecipient) === null || _d === void 0 ? void 0 : _d.length)) {
            ...
            if (steps[0].items.length > 1) {
                ...
                for (let i = 0; i < steps[0].items.length; i++) {
                    const itemAmount = (0, utils_1.bn)(((_e = steps[0].items[i].data) === null || _e === void 0 ? void 0 : _e.value) || 0);
