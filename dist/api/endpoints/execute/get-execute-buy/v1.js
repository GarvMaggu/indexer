...
exports.getExecuteBuyV1Options = void 0;
...
const version = "v1";
exports.getExecuteBuyV1Options = {
    ...
    validate: {
        query: joi_1.default.object({
            ...
            tokens: joi_1.default.array().items(joi_1.default.string().lowercase().pattern(utils_1.regex.token)),
            taker: joi_1.default.string().lowercase().pattern(utils_1.regex.address).required(),
            onlyQuote: joi_1.default.boolean().default(false),
            source: joi_1.default.string().lowercase(),
            referrer: joi_1.default.string().lowercase().pattern(utils_1.regex.address).default(constants_1.AddressZero),
            referrerFeeBps: joi_1.default.number().integer().min(0).max(10000).default(0),
            partial: joi_1.default.boolean().default(false),
            ...
            skipBalanceCheck: joi_1.default.boolean().default(false),
        })
            .or("token", "tokens")
            .oxor("token", "tokens")
            .with("quantity", "token"),
