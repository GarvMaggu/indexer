...
exports.getExecuteBuyV4Options = void 0;
...
const version = "v4";
exports.getExecuteBuyV4Options = {
    ...
    handler: async (request) => {
        ...
        try {
            ...
            // Handle fees on top
            if (((_a = payload.feesOnTop) === null || _a === void 0 ? void 0 : _a.length) > 1) {
                throw Boom.badData("For now, only a single fee on top is supported");
            }
            else if (((_b = payload.feesOnTop) === null || _b === void 0 ? void 0 : _b.length) === 1) {
            ...
            const addToPath = async (order, token) => {
                ...
                const rawQuote = totalPrice.add(totalPrice.mul((_b = payload.referrerFeeBps) !== null && _b !== void 0 ? _b : 0).div(10000));
                path.push({
                    orderId: order.id,
                    contract: token.contract,
                    tokenId: token.tokenId,
                    quantity: (_c = token.quantity) !== null && _c !== void 0 ? _c : 1,
                    source: order.sourceId !== null ? (_e = (_d = sources.get(order.sourceId)) === null || _d === void 0 ? void 0 : _d.domain) !== null && _e !== void 0 ? _e : null : null,
                    currency: order.currency,
                    quote: (0, utils_1.formatPrice)(rawQuote, (await (0, currencies_1.getCurrency)(order.currency)).decimals),
            ...
            `, {
                    ...
                    await addToPath({
                        ...
                        quantity: (_d = payload.quantity) !== null && _d !== void 0 ? _d : 1,
                    });
                }
            }
            // Scenario 3: passing the tokens and quantity to fill
            if (payload.tokens) {
                const preferredOrderSource = (_e = sources.getByDomain(payload.preferredOrderSource)) === null || _e === void 0 ? void 0 : _e.id;
            ...
            const tx = await router.fillListingsTx(listingDetails, payload.taker, {
                ...
                fee: {
                    recipient: (_f = payload.referrer) !== null && _f !== void 0 ? _f : constants_1.AddressZero,
                    bps: (_g = payload.referrerFeeBps) !== null && _g !== void 0 ? _g : 0,
                },
