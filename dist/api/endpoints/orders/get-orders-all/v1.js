...
exports.getOrdersAllV1Options = void 0;
      ...
      `;
            ...
            const result = rawResult.map((r) => {
                ...
                return ({
                    ...
                    rawData: (_b = r.raw_data) !== null && _b !== void 0 ? _b : undefined,
                    metadata: (_c = r.metadata) !== null && _c !== void 0 ? _c : undefined,
                });
            });
            return {
                orders: result,
