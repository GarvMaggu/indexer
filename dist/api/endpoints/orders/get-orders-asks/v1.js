...
exports.getOrdersAsksV1Options = void 0;
...
const version = "v1";
exports.getOrdersAsksV1Options = {
    ...
    validate: {
        query: joi_1.default.object({
            ...
            sortBy: joi_1.default.string().valid("price", "createdAt"),
    ...
    handler: async (request) => {
      ...
      `;
            ...
            if (query.token) {
                // Valid orders
                conditions.push(`orders.fillability_status = 'fillable' AND orders.approval_status = 'approved'`);
            ...
            if (query.maker) {
                switch (query.status) {
                    case "inactive": {
                        ...
                        conditions.push(`orders.fillability_status = 'no-balance' OR (orders.fillability_status = 'fillable' AND orders.approval_status != 'approved')`);
                        break;
                    }
                    case "active":
                    default: {
