...
exports.getOrdersAsksV3Options = void 0;
...
const version = "v3";
exports.getOrdersAsksV3Options = {
    description: "Asks (listings)",
    notes: "Get a list of asks (listings), filtered by token, collection or maker. This API is designed for efficiently ingesting large volumes of orders, for external processing",
    tags: ["api", "Orders"],
    plugins: {
        "hapi-swagger": {
            order: 5,
    ...
    validate: {
        query: joi_1.default.object({
            ids: joi_1.default.alternatives(joi_1.default.string(), joi_1.default.array().items(joi_1.default.string())).description("Order id(s) to search for."),
            ...
            contracts: joi_1.default.alternatives()
                .try(joi_1.default.array().max(50).items(joi_1.default.string().lowercase().pattern(utils_1.regex.address)), joi_1.default.string().lowercase().pattern(utils_1.regex.address))
            ...
            includePrivate: joi_1.default.boolean()
                .default(false)
    ...
    response: {
        schema: joi_1.default.object({
            orders: joi_1.default.array().items(joi_1.default.object({
                ...
                isDynamic: joi_1.default.boolean(),
        ...
        failAction: (_request, _h, error) => {
            logger_1.logger.error(`get-orders-asks-${version}-handler`, `Wrong response schema: ${error}`);
            throw error;
        },
    },
    handler: async (request) => {
      ...
      `;
            // Filters
            const conditions = [`orders.side = 'sell'`];
            ...
            if (!query.includePrivate) {
                conditions.push(`orders.taker = '\\x0000000000000000000000000000000000000000' OR orders.taker IS NULL`);
            }
            ...
            const result = rawResult.map(async (r) => {
                ...
                return {
                    ...
                    price: await (0, joi_2.getJoiPriceObject)({
                        ...
                        net: {
                            amount: (0, utils_1.getNetAmount)((_c = r.currency_price) !== null && _c !== void 0 ? _c : r.price, r.fee_bps),
            ...
            logger_1.logger.error(`get-orders-asks-${version}-handler`, `Handler failure: ${error}`);
            throw error;
        }
    },
};
