...
exports.getOrdersBidsV1Options = void 0;
...
const version = "v1";
exports.getOrdersBidsV1Options = {
      ...
      `;
            ...
            if (query.maker) {
                switch (query.status) {
                    ...
                    case "expired": {
                        // Invalid orders
                        conditions.push(`orders.fillability_status != 'fillable' AND orders.fillability_status != 'no-balance'`);
                        break;
                    }
                    case "active":
                    default: {
