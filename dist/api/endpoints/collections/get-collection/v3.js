...
exports.getCollectionV3Options = void 0;
...
const version = "v3";
exports.getCollectionV3Options = {
                    ...
                    : {
                        ...
                        metadata: {
                            ...
                            imageUrl: assets_1.Assets.getLocalAssetsLink((_a = r.metadata) === null || _a === void 0 ? void 0 : _a.imageUrl) ||
                                (((_b = r.sample_images) === null || _b === void 0 ? void 0 : _b.length) ? assets_1.Assets.getLocalAssetsLink(r.sample_images[0]) : null),
                        },
                        ...
                        floorAsk: {
                            id: r.floor_sell_id,
                            sourceDomain: (_c = sources.get(r.floor_sell_source_id_int)) === null || _c === void 0 ? void 0 : _c.domain,
