...
const activitiesEndpoints = __importStar(require("@/api/endpoints/activities"));
const adminEndpoints = __importStar(require("@/api/endpoints/admin"));
const apiKeysEndpoints = __importStar(require("@/api/endpoints/api-keys"));
const attributesEndpoints = __importStar(require("@/api/endpoints/attributes"));
const collectionsEndpoints = __importStar(require("@/api/endpoints/collections"));
const collectionsSetsEndpoints = __importStar(require("@/api/endpoints/collections-sets"));
const eventsEndpoints = __importStar(require("@/api/endpoints/events"));
const executeEndpoints = __importStar(require("@/api/endpoints/execute"));
const healthEndpoints = __importStar(require("@/api/endpoints/health"));
const oracleEndpoints = __importStar(require("@/api/endpoints/oracle"));
const ordersEndpoints = __importStar(require("@/api/endpoints/orders"));
const ownersEndpoints = __importStar(require("@/api/endpoints/owners"));
const redirectsEndpoints = __importStar(require("@/api/endpoints/redirects"));
const searchEndpoints = __importStar(require("@/api/endpoints/search"));
const statsEndpoints = __importStar(require("@/api/endpoints/stats"));
const tokensEndpoints = __importStar(require("@/api/endpoints/tokens"));
const transactionsEndpoints = __importStar(require("@/api/endpoints/transactions"));
const transfersEndpoints = __importStar(require("@/api/endpoints/transfers"));
const assetsEndpoints = __importStar(require("@/api/endpoints/assets"));
