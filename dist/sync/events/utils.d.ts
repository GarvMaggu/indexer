...
export declare const fetchTransaction: (txHash: string) => Promise<import("@/models/transactions").Transaction | Pick<import("@/models/transactions").Transaction, "hash" | "data" | "to" | "from" | "value">>;
