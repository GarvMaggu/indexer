...
exports.getNetworkSettings = exports.getServiceName = exports.getNetworkName = void 0;
...
const getServiceName = () => {
    const isRailway = index_1.config.railwayStaticUrl !== "";
    return `indexer-${isRailway ? "" : "fc-"}${index_1.config.version}-${(0, exports.getNetworkName)()}`;
};
