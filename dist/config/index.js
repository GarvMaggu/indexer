...
exports.config = {
    ...
    traceNetworkHttpUrl: String((_a = process.env.TRACE_NETWORK_HTTP_URL) !== null && _a !== void 0 ? _a : process.env.BASE_NETWORK_HTTP_URL),
    ...
    metadataIndexingMethodCollection: String(process.env.METADATA_INDEXING_METHOD_COLLECTION ||
        process.env.METADATA_INDEXING_METHOD ||
        "opensea"),
    metadataApiBaseUrl: String(process.env.METADATA_API_BASE_URL),
    metadataApiBaseUrlAlt: String(process.env.METADATA_API_BASE_URL_ALT || process.env.METADATA_API_BASE_URL),
    ...
    writeReplicaDatabaseUrl: String(process.env.WRITE_REPLICA_DATABASE_URL || process.env.DATABASE_URL),
