...
const build = async (options) => {
    try {
      ...
      `, {
        ...
        const builder = new Sdk.LooksRare.Builders.SingleToken(index_1.config.chainId);
        ...
        logger_1.logger.error("looks-rare-build-sell-token-order", `Failed to build order: ${error}`);
        return undefined;
    }
};
exports.build = build;
