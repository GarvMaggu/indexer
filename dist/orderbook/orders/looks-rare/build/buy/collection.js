...
const utils = __importStar(require("@/orderbook/orders/looks-rare/build/utils"));
const build = async (options) => {
    ...
    if (!(collectionResult === null || collectionResult === void 0 ? void 0 : collectionResult.id) || collectionResult.id.includes(":")) {
    ...
    const builder = new Sdk.LooksRare.Builders.ContractWide(index_1.config.chainId);
