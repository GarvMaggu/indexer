...
const build = async (options) => {
    try {
      ...
      `, {
        ...
        const buildInfo = await utils.getBuildInfo(options, collectionResult.collection_id, Sdk.Universe.Types.OrderSide.SELL);
        if (!buildInfo) {
        ...
        logger_1.logger.error("universe-build-sell-token-order", `Failed to build order: ${error}`);
        return undefined;
    }
};
exports.build = build;
