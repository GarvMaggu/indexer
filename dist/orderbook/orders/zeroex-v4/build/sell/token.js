...
const build = async (options) => {
    try {
      ...
      `, {
        ...
        const builder = new Sdk.ZeroExV4.Builders.SingleToken(index_1.config.chainId);
        ...
        logger_1.logger.error("zeroex-v4-build-sell-token-order", `Failed to build order: ${error}`);
        return undefined;
    }
};
exports.build = build;
